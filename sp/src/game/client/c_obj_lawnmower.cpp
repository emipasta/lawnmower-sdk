...
// Purpose: 
//-----------------------------------------------------------------------------
class C_VehicleLawnmower : public C_BaseAnimating, public IClientVehicle
{
	DECLARE_CLASS(C_VehicleLawnmower, C_BaseAnimating);
...
IMPLEMENT_CLIENTCLASS_DT(C_VehicleLawnmower, DT_VehicleLawnmower, CVehicleLawnMower)
...
BEGIN_DATADESC(C_VehicleLawnmower)
...
// Purpose: 
//-----------------------------------------------------------------------------
C_VehicleLawnmower::C_VehicleLawnmower(void)
{
...
// Input  : updateType - 
//-----------------------------------------------------------------------------
void C_VehicleLawnmower::PreDataUpdate(DataUpdateType_t updateType)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_VehicleLawnmower::PostDataUpdate(DataUpdateType_t updateType)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
C_BaseCombatCharacter *C_VehicleLawnmower::GetPassenger(int nRole)
{
...
//-----------------------------------------------------------------------------
int	C_VehicleLawnmower::GetPassengerRole(C_BaseCombatCharacter *pPassenger)
{
...
//-----------------------------------------------------------------------------
void C_VehicleLawnmower::GetVehicleViewPosition(int nRole, Vector *pAbsOrigin, QAngle *pAbsAngles, float *pFOV /*=NULL*/)
{
...
//			pCmd - 
//-----------------------------------------------------------------------------
void C_VehicleLawnmower::UpdateViewAngles(C_BasePlayer *pLocalPlayer, CUserCmd *pCmd)
{
...
//-----------------------------------------------------------------------------
void C_VehicleLawnmower::GetVehicleClipPlanes(float &flZNear, float &flZFar) const
{
...
//-----------------------------------------------------------------------------
void C_VehicleLawnmower::DrawHudElements()
{
}
